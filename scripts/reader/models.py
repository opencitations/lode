...
class Resource():
    ...
    def get_has_comment(self):
        ...
        return list(set(self._has_comment))
    ...
    def get_has_label(self):
        ...
        return list(set(self._has_label))
    ...
    def get_has_preferred_label(self):
        ...
        return list(set(self._has_preferred_label))
    ...
    def get_has_alternative_label(self):
        ...
        return list(set(self._has_alternative_label))
    ...
    def get_has_hidden_label(self):
        ...
        return list(set(self._has_hidden_label))
    ...
    def get_has_notation(self):
        ...
        return list(set(self._has_notation))
    ...
    def get_has_note(self):
        ...
        return list(set(self._has_note))
    ...
    def get_has_definition(self):
        ...
        return list(set(self._has_definition))
    ...
    def get_has_editorial_note(self):
        ...
        return list(set(self._has_editorial_note))
    ...
    def get_has_example(self):
        ...
        return list(set(self._has_example))
    ...
    def get_has_history_note(self):
        ...
        return list(set(self._has_history_note))
    ...
    def get_has_scope_note(self):
        ...
        return list(set(self._has_scope_note))
    ...
    def get_see_also(self):
        ...
        return list(set(self._see_also))
    ...
    def get_is_defined_by(self):
        ...
        return list(set(self._is_defined_by))
    ...
    def get_has_version_info(self):
        ...
        return list(set(self._has_version_info))
    ...
    def get_has_type(self):
        ...
        return list(set(self._has_type))
    ...
    def get_is_included_in(self):
        ...
        return list(set(self._is_included_in))
